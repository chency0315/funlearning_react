    ...
    return (
        <nav className="navbar navbar-expand-lg fixed-top" style={{ backgroundColor: 'orange' }}>
            <div className="container-fluid">
                ...
                <button class="navbar-toggler" type="button" onClick={toggleCollapse} data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation" >
